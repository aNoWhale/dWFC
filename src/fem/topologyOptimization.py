...
rho_ini = np.ones((Nx,Ny,Nz,tileHandler.typeNum),dtype=np.float64).reshape(-1,tileHandler.typeNum)*0.7
rho_ini = rho_ini.at[:,1].set(0.7)
rho_ini = rho_ini.at[:,2].set(0.7)
